...
func load_data() -> void:
	...
	#key_period_image_path = action_icon._get_keyboard(KEY_PERIOD).get_path()
	...
	key_2_image_path = "[img={key_2_width}x{key_2_height}]{key_2_image}[/img]\n".format({"key_2_width": 0, "key_2_height": 40, "key_2_image": key_2_image_path})
	...
	key_5_image_path = "[img={key_5_width}x{key_5_height}]{key_5_image}[/img]\n".format({"key_5_width": 0, "key_5_height": 40, "key_5_image": key_5_image_path})
	...
	key_8_image_path = "[img={key_8_width}x{key_8_height}]{key_8_image}[/img]\n".format({"key_8_width": 0, "key_8_height": 40, "key_8_image": key_8_image_path})
	...
	#key_period_image_path = "[img={key_period_width}x{key_period_height}]{key_period_image}[/img]\n".format({"key_period_width": 0, "key_period_height": 40, "key_period_image": key_period_image_path})
	key_period_image_path = "."
	key_backspace_image_path = "[img={key_backspace_width}x{key_backspace_height}]{key_backspace_image}[/img]\n".format({"key_backspace_width": 80, "key_backspace_height": 60, "key_backspace_image": key_backspace_image_path})
	_str += key_0_image_path + key_1_image_path + key_2_image_path + key_3_image_path + key_4_image_path + key_5_image_path + key_6_image_path + key_7_image_path + key_8_image_path + key_9_image_path + key_backspace_image_path
	# Teclado:
